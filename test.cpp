...
BOOST_AUTO_TEST_SUITE(FixedWidthAddTests)

BOOST_AUTO_TEST_CASE(test_basic_addition) {
    cpp_int a = 5;   // 101
    cpp_int b = 3;   // 011
    BOOST_CHECK_EQUAL(fixed_width_add(a, b, 4), 8);  // 1000 -> 1000
}

BOOST_AUTO_TEST_CASE(test_no_overflow) {
    cpp_int a = 7;   // 0111
    cpp_int b = 8;   // 1000
    BOOST_CHECK_EQUAL(fixed_width_add(a, b, 5), 15);  // 01111
}

BOOST_AUTO_TEST_CASE(test_zero_addition) {
    cpp_int a = 0;
    cpp_int b = 0;
    BOOST_CHECK_EQUAL(fixed_width_add(a, b, 8), 0);
}

BOOST_AUTO_TEST_CASE(test_invalid_bits) {
    cpp_int a = 1;
    cpp_int b = 1;
    BOOST_CHECK_THROW(fixed_width_add(a, b, 0), std::invalid_argument);
}
