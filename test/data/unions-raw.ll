...
define dso_local i32 @punned(float noundef %0) #0 {
  ...
  store float %0, ptr %2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %3) #3
  %4 = load float, ptr %2, align 4, !tbaa !5
  store float %4, ptr %3, align 4, !tbaa !9
...
define dso_local i32 @set_live(i32 %0, i1 noundef zeroext %1) #0 {
  ...
  %7 = load i8, ptr %5, align 1, !tbaa !12, !range !14, !noundef !15
  %8 = trunc i8 %7 to i1
  %9 = zext i1 %8 to i32
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %3, ptr align 4 %4, i64 4, i1 false), !tbaa.struct !16
...
define dso_local i32 @tight_n(ptr noundef %0) #0 {
  ...
  %5 = load i32, ptr %4, align 1, !tbaa !20
  ret i32 %5
}
...
define dso_local signext i16 @tight_s(ptr noundef %0) #0 {
  ...
  %5 = load i16, ptr %4, align 1, !tbaa !23
  ret i16 %5
}
...
!16 = !{i64 0, i64 2, !9}
!17 = !{!18, !18, i64 0}
!18 = !{!"p1 _ZTS5tight", !19, i64 0}
!19 = !{!"any pointer", !7, i64 0}
!20 = !{!21, !11, i64 1}
!21 = !{!"tight", !7, i64 0, !11, i64 1, !22, i64 5}
!22 = !{!"short", !7, i64 0}
!23 = !{!21, !22, i64 5}
