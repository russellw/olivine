...
define dso_local i32 @through_slot(i32 noundef %0) local_unnamed_addr #2 {
  ...
  call void asm sideeffect "addl $$7, $0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %2, ptr nonnull elementtype(i32) %2) #4, !srcloc !17
...
define dso_local i32 @hidden(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = add nsw i32 %1, %0
  %4 = shl nsw i32 %3, 1
  %5 = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %4) #3, !srcloc !18
  ret i32 %5
}
...
4:                                                ; preds = %2
  %5 = tail call i32 asm "bswapl $0", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %0) #3, !srcloc !19
  %6 = ashr i32 %5, 24
  %7 = mul i32 %6, %1
  br label %8
...
define dso_local i32 @both_kinds(i32 noundef %0) local_unnamed_addr #2 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %2) #4
  store i32 %0, ptr %2, align 4, !tbaa !8
  call void asm sideeffect "addl $$1, $0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %2, ptr nonnull elementtype(i32) %2) #4, !srcloc !20
