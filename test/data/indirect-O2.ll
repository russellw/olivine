...
define dso_local i32 @dispatch(i32 noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  ...
  %8 = tail call i32 %7(i32 noundef %1, i32 noundef %2) #4
  ret i32 %8
}
...
define dso_local i32 @gcd(i32 noundef %0, i32 noundef %1) local_unnamed_addr #2 {
  %3 = icmp eq i32 %1, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local range(i32 -1, 2) i32 @parity(i32 noundef %0) local_unnamed_addr #2 {
  %2 = icmp slt i32 %0, 0
...
define dso_local i32 @apply_twice(ptr noundef readonly captures(none) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = tail call i32 %0(i32 noundef %1, i32 noundef %2) #4
  %5 = tail call i32 %0(i32 noundef %4, i32 noundef %2) #4
  ret i32 %5
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal i32 @add(i32 noundef %0, i32 noundef %1) #3 {
  %3 = add nsw i32 %1, %0
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal i32 @sub(i32 noundef %0, i32 noundef %1) #3 {
  %3 = sub nsw i32 %0, %1
  ret i32 %3
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define internal i32 @mul(i32 noundef %0, i32 noundef %1) #3 {
  %3 = mul nsw i32 %1, %0
  ret i32 %3
}
