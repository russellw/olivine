...
define dso_local i32 @caught_value(i32 noundef %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  %2 = icmp slt i32 %0, 0
...
; Function Attrs: mustprogress uwtable
define dso_local range(i32 -1, -2147483648) i32 @caught_anything(i32 noundef %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  %2 = icmp slt i32 %0, 0
  br i1 %2, label %3, label %6
